function [ similarity_matrix ] = pattern_similarity_of_feature( featureMethod, corpus_patterns )
...
similarity_matrix = pattern_similarity(feature_matrix(featureMethod, corpus_patterns));
