function [ acceptable_files, octave_errors, annotation_indices ] = prune_bad_beat_tracking( computed_dir, annotated_downbeat_files, only_beats )
    ...
    if(nargin >= 3 && beats_per_measure ~= only_beats)
        ...
        if (f_score > f_score_threshold)
            ...
            if(round(recall / precision) == 2)
                ...
                [annotationTimes, annotationMarkers] = annotated_beats(annotated_downbeat_files{i});
